...
- 🔍 **マルチユニバース対応**: S&P 500, S&P 400, Nasdaq 100
...
- **S&P 500**: 米国大型株（502銘柄）
- **S&P 400**: 米国中型株（401銘柄）
- **Nasdaq 100**: Nasdaq主要100銘柄（102銘柄）
- **Other**: その他市場
- **日本株（東証）**: 東証プライム・スタンダード・グロース全銘柄
- **CSV**: カスタム銘柄リスト
...
- [x] Excel形式のエクスポート（メニューから選択可能）
- [x] 日本株専用ユニバース対応（東証プライム/スタンダード/グロース）
- [x] PyInstaller実行ファイルビルド対応
